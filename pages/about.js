					...
					<ul className="timeline">
						...
						<li>
							...
							<p>
								...
								of the main disadvantages they face compared to college educated
								graduates in computer science is the fact that they don&apos;t
								have knowledge about algorithms, data structures and the
								notorious Big-O Notation
							</p>
						</li>
						<li>
							<a
					...
					<ul className="timeline">
						<li>
							...
							<p>
								...
								standout and the ones that i personally love, NOTE this is just
								by preference actually.
							</p>
						</li>
					</ul>
				</PageWrapper>
