          ...
          <PageWrapper>
           ...
           <Tabs>
                ...
                <div label="Projects">
                  <MansoryLayout>
                    {
                      this.state.data.map((item, index) => item.type.includes('project') && (
                          <MansoryItem key={index} index={index} item={item}/>
                      ))
                    }
                  </MansoryLayout>
                ...
                <div label="Dev Tools">
                  <MansoryLayout>
                    {
                      this.state.data.map((item, index) => item.type.includes('tools') && (
                          <MansoryItem key={index} index={index} item={item}/>
                      ))
                    }
                  </MansoryLayout>
                ...
                <div label="Open Source">
                  <MansoryLayout>
                      {
                        this.state.data.map((item, index) => item.type.includes('open-source') && (
                            <MansoryItem key={index} index={index} item={item}/>
                      ))
                    }
                  </MansoryLayout>
                ...
                <div label="Others">
                  <MansoryLayout>
                      {
                        this.state.data.map((item, index) => item.type.includes('others') && (
                            <MansoryItem key={index} index={index} item={item}/>
                      ))
                    }
                  </MansoryLayout>
